    ...
    useEffect(() => {
        ...
        fabric.util.requestAnimFrame(function render() {
            try {
                ...
                console.log(error, 'Failed to render canvas canvas.renderAll: Editor.tsx');
            }
        });
    }, []);
    return (
        <div className="grid grid-rows-[500px_1fr_20px] grid-cols-[72px_300px_1fr_250px] h-[100svh]">
            ...
            <div className="col-span-4 text-right px-2 text-[0.5em] bg-black text-white">Crafted By Amit Digga</div>
        </div>
    );
});
